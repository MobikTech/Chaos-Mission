...
//         {
//             _moveController.MovingStates[MovingStateType.Walking].StateStartedAction += OnRunningStarted;
//             _moveController.MovingStates[MovingStateType.Walking].StateStoppedAction += OnRunningStopped; 
//         }
//
